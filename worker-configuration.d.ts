/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8efdc5caeb05265b43252d4eea656947)
// Runtime types generated with workerd@1.20260611.1 2026-06-12 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	GOOGLE_CLIENT_ID: "REPLACE_WITH_GOOGLE_CLIENT_ID";
	GOOGLE_REDIRECT_URI: "https://hana-counter.hanacus87.net/auth/callback";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_REDIRECT_URI">> {}
}
